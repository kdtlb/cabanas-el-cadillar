...
(function () {
  ...
  if (toggle && mobile) {
    if (!mobile.querySelector('.nav__mobile__links')) {
      ...
      foot.innerHTML = '<span class="nav__mobile__foot-label">¿Consultas? Estamos para ayudarle</span><a class="btn btn--gold" href="https://wa.me/59175600149?text=Hola,%20quiero%20consultar%20por%20El%20Cadillar%20Apart%20Hotel" target="_blank" rel="noopener">Escríbanos por WhatsApp</a>';
  ...
  if (!document.querySelector('.wa-float')) {
    ...
    wa.href = 'https://wa.me/59175600149?text=Hola,%20quiero%20consultar%20por%20El%20Cadillar%20Apart%20Hotel';
    wa.target = '_blank';
    wa.rel = 'noopener';
