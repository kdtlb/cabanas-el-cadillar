  ...
  const CABINS = [
    {
      ...
      capacity: '3 personas', beds: '1 matrimonial + 1 individual', spec3: 'Hogar a leña',
      short: 'Living-comedor de ladrillo visto con hogar a leña de piedra, cálida y hogareña.',
    ...
    },
    {
      ...
      capacity: '4 personas', beds: '1 matrimonial + 2 individuales', spec3: 'Quincho propio',
      short: 'Con quincho propio de parrilla a leña y muros de piedra, hecha para el asado.',
    ...
    },
    {
      ...
      capacity: '2 personas', beds: '1 cama matrimonial', spec3: 'Galería propia',
    ...
    {
      dir: 4, slug: 'cabana-4', name: 'Cabaña 4', tag: 'Estudio con kitchenette',
      photos: 3, hero: 1, design: 2,
      capacity: '2 personas', beds: '1 cama matrimonial', spec3: 'Kitchenette',
      short: 'Estudio práctico y cálido, con kitchenette equipada y pared de piedra.',
      long: 'La Cabaña 4 es un estudio cómodo y bien resuelto: dormitorio, kitchenette equipada y rincón de comedor en un mismo ambiente, con una linda pared de piedra bola como protagonista. Ideal para una pareja que busca autonomía y descanso.',
      highlight: 'Kitchenette equipada con frigobar y microondas.',
    ...
    },
    {
      ...
      capacity: '2 personas', beds: '2 camas individuales', spec3: 'Kitchenette',
      short: 'Ambiente cómodo con dos camas y kitchenette, ideal para amigos.',
      long: 'Con dos camas, kitchenette de azulejos y detalles en madera, la Cabaña 5 es práctica y acogedora. Una buena opción para amigos o para quienes prefieren camas separadas, sin resignar comodidad.',
      highlight: 'Dos camas individuales y kitchenette equipada.',
      amenities: ['Dos camas', 'Kitchenette', 'Frigobar', 'Microondas', 'Smart TV', 'Baño privado', 'Agua caliente', 'WiFi']
    },
    {
    ...
    },
    {
      ...
      capacity: '3 personas', beds: '1 matrimonial + 1 individual', spec3: 'Living amplio',
    ...
    },
    {
      ...
      capacity: '2 personas', beds: '1 cama matrimonial', spec3: 'Smart TV',
    ...
    },
    {
      ...
      capacity: '4 personas', beds: '2 dormitorios', spec3: 'Dos dormitorios',
      short: 'La más rústica: muros de adobe, nichos de época y dos dormitorios.',
    ...
    },
    {
      ...
      capacity: '4 personas', beds: 'Camas individuales + loft', spec3: 'Loft',
