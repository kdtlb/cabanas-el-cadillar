...
<title>${c.name} — El Cadillar Apart Hotel</title>
<meta name="description" content="${c.short}">
<meta property="og:type" content="website">
<meta property="og:site_name" content="El Cadillar Apart Hotel">
<meta property="og:locale" content="es_BO">
<meta property="og:title" content="${c.name} — El Cadillar Apart Hotel">
...
<link rel="icon" type="image/png" href="../assets/img/marca/isotipo.png">
</head>
<body>
...
<nav class="nav nav--solid">
  <div class="nav__inner">
    ...
    <ul class="nav__links">
      ...
      <li><a href="../eventos.html">Empresas</a></li>
...
<div class="nav__mobile">
  ...
  <a href="../eventos.html">Empresas</a>
...
<header class="cabin-hero cabin-hero--${COLOR_POR_PAX[c.pax] || 'salvia'}">
  <div class="container cabin-hero__content">
    ...
    <div class="cabin-hero__meta">
      ...
      <span><span class="ico" data-icon="ruler"></span> ${c.m2} m²</span>
  ...
  <div class="container cabin-content">
    ...
    <div class="cabin-section reveal">
      ...
      <div class="cabin-specs">
        ...
        <div class="cabin-spec"><span class="ico" data-icon="ruler"></span><b>${c.m2} m²</b><span>Superficie</span></div>
    ...
    <div class="cabin-contact reveal">
      <div class="cabin-contact__text">
        ...
        <p>Escríbanos desde cualquier país: le contamos disponibilidad, precios y cómo llegar, sin compromiso y sin paquetes cerrados. Le respondemos dentro de las 24 horas.</p>
      </div>
      <div class="cabin-contact__actions">
        <a href="../reservas.html?cabana=${c.slug}" class="btn btn--gold btn--lg">Pedir más información</a>
        <a href="https://wa.me/59175600149?text=Hola,%20quiero%20consultar%20por%20la%20${encodeURIComponent(c.name)}" class="btn btn--ghost-light btn--lg" target="_blank" rel="noopener">Consultar por WhatsApp</a>
      </div>
    </div>
  ...
  <div class="container">
    <div class="footer__grid">
      <div class="footer__brand">
        ...
        <p>Diez cabañas al pie de los cerros, en el corazón de los valles de Tarija, Bolivia.</p>
        <div class="footer__social"><a href="https://www.instagram.com/cabanasdelcadillar/" target="_blank" rel="noopener" aria-label="Instagram"><span class="ico" data-icon="instagram"></span></a><a href="https://www.facebook.com/TarijaHospedaje/" target="_blank" rel="noopener" aria-label="Facebook"><span class="ico" data-icon="facebook"></span></a><a href="https://wa.me/59175600149" aria-label="WhatsApp"><span class="ico" data-icon="whatsapp"></span></a></div>
      </div>
    ...
    <div class="footer__bottom">
      ...
      <span class="footer__credit">Desarrollado por <a href="https://buck-di.com" target="_blank" rel="noopener"><strong>BUCKDI</strong></a></span>
    </div>
  </div>
</footer>
